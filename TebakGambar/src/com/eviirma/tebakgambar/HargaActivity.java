...
public class HargaActivity extends Activity {
	...
	public void cekJawaban(View v){
		String jawabanBenar = "HARGA TERJANGKAU";
		...
		if(jawabanUSer.equals(jawabanBenar)){
			...
			Intent i = new Intent(getApplicationContext(), JagungActivity.class);
			startActivity(i);
		}
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.harga, menu);
		return true;
	}
