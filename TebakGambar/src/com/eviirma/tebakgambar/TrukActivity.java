...
public class TrukActivity extends Activity {
 	EditText jawabanTxt;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_truk);
jawabanTxt = (EditText)findViewById(R.id.editText1);
	...
	public void cekJawaban(View v){
		String jawabanBenar = "TRUK RUSAK";
		...
		if(jawabanUSer.equals(jawabanBenar)){
			...
			Intent i = new Intent(getApplicationContext(), TrukActivity.class);
			startActivity(i);
		}
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.truk, menu);
		return true;
	}
