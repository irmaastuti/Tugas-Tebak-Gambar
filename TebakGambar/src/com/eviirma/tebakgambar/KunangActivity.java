package com.eviirma.tebakgambar;
...
public class KunangActivity extends Activity {
	//deklarasi variabel (line 10 dibawah public class) 
  	EditText jawabanTxt;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_kunang);
jawabanTxt = (EditText)findViewById(R.id.editText1);
	...
	public void cekJawaban(View v){
		String jawabanBenar = "KUNANG-KUNANG";
		...
		if(jawabanUSer.equals(jawabanBenar)){
			...
			Intent i = new Intent(getApplicationContext(), KupuActivity.class);
			startActivity(i);
		}
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.kunang, menu);
		return true;
	}
