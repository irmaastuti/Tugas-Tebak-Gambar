...
public class KupuActivity extends Activity {
	//deklarasi variabel (line 10 dibawah public class) 
  	EditText jawabanTxt;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_kupu);
jawabanTxt = (EditText)findViewById(R.id.editText1);
	...
	public void cekJawaban(View v){
		String jawabanBenar = "KUPU-KUPU MALAM";
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.kupu, menu);
		return true;
	}
